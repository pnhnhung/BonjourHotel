...
import './GioiThieuPhongPY.css'
import imgphongpy from '../Assets/image-gioithieuphong-chinhanh.png'
import imgphongpy2 from '../Assets/image-gioithieuphong-chinhanh2.png'
import imgphongpy3 from '../Assets/image-gioithieuphong-chinhanh3.png'
...
const GioiThieuPhongPY = () => {

  const images = [imgphongpy, imgphongpy2, imgphongpy3];
  ...
  return (
      <div className='gioithieu-phongpy'>
          <div className="container-phongpy">
              <div className="content-phongpy">
                  <div className="content-phongpy-left">
                      <h2>JUNIOR ROOM</h2>
                  ...
                  <div className="content-phongpy-right">
...
export default GioiThieuPhongPY
